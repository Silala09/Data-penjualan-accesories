...
$pinjam = query("SELECT * FROM data_game");
  ...
  <div class="container">
    <nav class="navbar navbar-light bg-dark object-fit-cover border rounded mt-3">
      <div class="container-fluid">
        <a class="navbar-brand text-white">Halaman Admin</a>
        ...
        <ul class="navbar-nav ms-2">
          <li class="nav-item">
            <a class="logout" aria-current="page" href="logout.php"><button type="button" class="btn btn-danger">Keluar</button></a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <table class="table table-hover table-bordered align-middle border border-blue">
      <thead>

        ...
        <div class="row">
            <div class="col-md-6 login-form-1">
                ...
                <form method="POST" action="">
                    <div class="form-group">
                        <input type="text" name="useremail" class="form-control" placeholder="Masukan Email " value="" />
                    </div>
                    <div class="form-group">
                        <input type="password" name="userpass" class="form-control" placeholder=" Password anda " value="" />
                    </div>
                    <div class="form-group">
                        <input type="submit" class="btnSubmit" name="btnlogin" value="Masuk" />
                    </div>
                </form>
            ...
            <div class="col-md-6 login-form-2">
                ...
                <form method="POST" action="Query.php">
                    <div class="form-group">
                        <input type="text" class="form-control" name="names" placeholder="Nama anda" value="" required />
                    </div>
                    <div class="form-group">
                        <input type="email" class="form-control" name="email" placeholder=" Email anda " value="" required />
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" name="passwords" placeholder=" Password " value="" required />
                    </div>
                    <div class="form-group">
                    ...
                    <input type="submit" name="btnregister" class="btnSubmit" value="Buat" />
                </form>
                <?php

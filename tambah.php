...
<body>
  <form action="" method="post" enctype="multipart/form-data">
    <h1>Tambah Data Pembeli Game</h1>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      <label for="merk_barang" class="form-label">Barang</label>
      <input type="text" name="merk_barang" class="form-control" id="merk_barang" required>
    </div>
    <div class="col-md-6">
